...
const file_models_proto_rawDesc = "" +
	"\n" +
	"\fmodels.proto\x12\x06models\"6\n" +
	"\bPosition\x12\f\n" +
	"\x01x\x18\x01 \x01(\x12R\x01x\x12\f\n" +
	"\x01y\x18\x02 \x01(\x12R\x01y\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02idB@Z>github.com/willH0lt/company-cursor-party/backend/shared/modelsb\x06proto3"
...
var file_models_proto_goTypes = []any{
	(*Position)(nil), // 0: models.Position
}
